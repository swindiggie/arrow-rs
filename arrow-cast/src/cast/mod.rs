...
mod tests {
    ...
    fn test_cast_list_i32_to_list_u16() {
        ...
        let cast_array = cast(
            &list_array,
            &DataType::List(Arc::new(Field::new("element", DataType::UInt16, true))),
        )
        .unwrap();
    ...
    fn test_cast_null_from_and_to_nested_type() {
        ...
        let data_type = DataType::List(Arc::new(Field::new("element", DataType::Int32, true)));
        cast_from_null_to_other(&data_type);
        let data_type = DataType::LargeList(Arc::new(Field::new("element", DataType::Int32, true)));
        cast_from_null_to_other(&data_type);
        let data_type =
            DataType::FixedSizeList(Arc::new(Field::new("element", DataType::Int32, true)), 4);
        cast_from_null_to_other(&data_type);
    ...
    fn test_can_cast_fsl_to_fsl() {
        ...
        let invalid_target =
            DataType::FixedSizeList(Arc::new(Field::new("element", DataType::Binary, true)), 2);
        assert!(!can_cast_types(from_array.data_type(), &invalid_target));

        let invalid_size =
            DataType::FixedSizeList(Arc::new(Field::new("element", DataType::Float16, true)), 5);
    ...
    fn test_cast_single_element_fixed_size_list() {
        ...
        let to_field_inner = Arc::new(Field::new("element", DataType::Float32, false));
    ...
    fn test_cast_list_to_fsl_subcast() {
        ...
        let res = cast_with_options(
            array.as_ref(),
            &DataType::FixedSizeList(Arc::new(Field::new("element", DataType::Int16, true)), 2),
            &CastOptions {
                safe: false,
                ..Default::default()
            },
    ...
    fn make_fixed_size_list_array_for_large_list() -> FixedSizeListArray {
        ...
        let list_data_type =
            DataType::FixedSizeList(Arc::new(Field::new("element", DataType::Int64, true)), 4);
        let list_data = ArrayData::builder(list_data_type)
            .len(2)
            .add_child_data(value_data)
            .build()
    ...
    fn test_list_cast_offsets() {
        ...
        let dt = DataType::LargeList(Arc::new(Field::new("element", DataType::Int32, true)));
    ...
    fn test_list_to_string() {
        ...
        let list_data_type = DataType::List(Arc::new(Field::new("element", DataType::Utf8, true)));
        let list_data = ArrayData::builder(list_data_type)
            .len(3)
            .add_buffer(value_offsets)
            .add_child_data(value_data)
