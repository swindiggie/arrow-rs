...
mod tests {
    ...
    fn test_calculate_array_levels_twitter_example() {
        ...
        let leaf_type = Field::new("element", DataType::Int32, false);
    ...
    fn test_calculate_one_level_1() {
        ...
        let field = Field::new("element", DataType::Int32, false);
    ...
    fn test_calculate_one_level_2() {
        ...
        let field = Field::new("element", DataType::Int32, true);
    ...
    fn test_calculate_array_levels_1() {
        let leaf_field = Field::new("element", DataType::Int32, false);
    ...
    fn list_single_column() {
        ...
        let a_list_type = DataType::List(Arc::new(Field::new("element", DataType::Int32, true)));
        ...
        let item_field = Field::new("element", a_list_type, true);
    ...
    fn test_list_of_struct() {
        ...
        let item_field = Field::new("element", DataType::Struct(fields.clone()), true);
    ...
    fn test_fixed_size_list() {
        ...
        let item_field = Field::new("element", a.data_type().clone(), true);
        let mut builder = levels(&item_field, a);
        builder.write(1..4);
        let levels = builder.finish();
    ...
    fn test_fixed_size_list_empty() {
        ...
        let item_field = Field::new("element", array.data_type().clone(), true);
    ...
    fn test_null_dictionary_values() {
        ...
        let item_field = Field::new("element", dict.data_type().clone(), true);
    ...
    fn mismatched_types() {
        let array = Arc::new(Int32Array::from_iter(0..10)) as ArrayRef;
        let field = Field::new("element", DataType::Float64, false);
